...
import com.redsea.ext.plugin.solr.utils.SolrUtils;

/**
 * @author liqingyang
 * @date 2016-5-30 下午2:45:41
 */
...
//	@Test
	...
	public static void AddDocs() {
	    ...
	    try {
	    	/*QueryParser queryParser = new QueryParser(Version.LUCENE_46, "title", null);
	    	Query query = queryParser.parse("我爱北京天安门");*/
...
//				 UpdateResponse rsp = req.process(server);
	...
	@Test
	public void test2(){
		Page g = SolrUtils.findPageBySolr("这是保险金", "1");
