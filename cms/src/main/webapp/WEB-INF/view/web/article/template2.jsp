...
<div class="index-bd">			
			...
			<div class="index-L detail2">
				...
				<div class="detail-L2">
					 <a>${article.publish_user } </a> 　| 　${x:format(article.publish_time,'yyyy-MM-dd HH:mm')}   <c:if test="${article.origin!=null&&article.origin!='' }"> &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp;来源：${article.origin}</c:if> <i><a href="">${x:getFolderName(article.folder_id)}</a></i>
				</div>
				<div class="detail-La01">
					<em></em>${article.summary }
			    </div>
				<div class="detail-L4">
