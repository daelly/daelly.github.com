package com.redsea.ext.plugin.image.handler;
...
import com.redsea.ext.plugin.image.Const;
import com.redsea.ext.plugin.image.exec.ThumbExec;
import com.redsea.ext.plugin.image.util.BigDecimalUtil;
import com.redsea.ext.plugin.image.util.FileUtil;
import com.redsea.ext.plugin.image.util.ImageUtil;
import com.redsea.ext.plugin.image.util.JSONUtil;
import com.redsea.ext.plugin.image.util.QueryUtil;
...
public class ImageHandler {
	...
	private Logger loggr = LoggerFactory.getLogger(ImageHandler.class);
