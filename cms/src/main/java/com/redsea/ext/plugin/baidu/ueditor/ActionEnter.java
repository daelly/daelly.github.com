package com.redsea.ext.plugin.baidu.ueditor;
...
import com.redsea.ext.plugin.baidu.ueditor.define.ActionMap;
import com.redsea.ext.plugin.baidu.ueditor.define.AppInfo;
import com.redsea.ext.plugin.baidu.ueditor.define.BaseState;
import com.redsea.ext.plugin.baidu.ueditor.define.State;
import com.redsea.ext.plugin.baidu.ueditor.hunter.ImageHunter;
import com.redsea.ext.plugin.baidu.ueditor.upload.Uploader;
...
public class ActionEnter {
	...
	private String invoke(HttpServletRequest request) {
		...
		String rootPath = PropKit.get("upload_path");
	...
	//	String ctxPath  = request.getContextPath();
		...
		String ctxPath=PropKit.get("basePath");
		if(StrKit.isBlank(ctxPath)){
